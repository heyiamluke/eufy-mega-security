...
The gateway-only PPCS probe has produced real H.264 and JPEG bytes for the test account's wired T8210 and battery T817L. The companion integration will expose live camera views plus `capture_snapshot` and `record_clip` in a subsequent, separately validated Home Assistant change.
