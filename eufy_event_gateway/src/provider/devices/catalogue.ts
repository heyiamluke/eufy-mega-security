...
export const DEVICE_COMPATIBILITY: readonly DeviceCompatibility[] = [
  ...
  },
  {
    ...
    topologies: { homebase3: { status: "confirmed", capabilities: { discovery: "confirmed", snapshots: "confirmed", liveVideo: "confirmed", enableControl: "confirmed", privacyMode: "confirmed", motionDetectionControl: "confirmed", nightVisionControl: "confirmed", sirenControl: "confirmed" }, quirks: ["Battery-shaped fields are suppressed.", "Privacy mode is write-only because it has no reliable readback state."] } },
    evidence: [{ status: "developer-tested", date: "2026-09-21", appVersion: developerRelease, integrationVersion: developerRelease, capabilities: ["discovery", "snapshots", "liveVideo", "enableControl", "privacyMode", "motionDetectionControl", "nightVisionControl", "sirenControl"], note: "Camera enablement, write-only privacy mode, motion detection, camera siren, and night vision were verified on local hardware. Night vision raw 0 is PureColor, 1 is Infrared, and 2 is Spotlight." }],
  },
  {
